...
class Trainer:
    ...
    def _inner_training_loop(
        ...
        if args.deepspeed:
            deepspeed_engine, optimizer, lr_scheduler = deepspeed_init(
                ...
                self, num_training_steps=max_steps, resume_from_checkpoint=resume_from_checkpoint # Resume_training, the original is resume_from _checkpoint
            )
    ...
    def _save(self, output_dir: Optional[str] = None, state_dict=None):
        ...
        # self.model.module.save_pretrained(output_dir)   #分布式保存
